...
export class BackgroundMonitoringService {
    ...
    private readonly STATE_DERIVATION_INTERVAL_BUSINESS_HOURS = 7500; // 7.5 seconds during business hours (middle ground between 5s and 10s)
    ...
    private readonly MONITORING_INTERVAL_BUSINESS_HOURS = 7500; // 7.5 seconds during business hours (6am-9pm CST) - middle ground between 5s and 10s
